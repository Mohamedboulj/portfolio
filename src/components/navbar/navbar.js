...
export function Navbar() {
  return (
    ...
    <label htmlFor="toggler"><i className="bi bi-list"></i></label>
     <div className="menu">
          <ul className="list">
           <li><NavLink to="/"  className={({ isActive }) => (isActive ? "NavLink-active" : "")}>ABOUT ME</NavLink></li>
           <li><NavLink to="/resume"  className={({ isActive }) => (isActive ? "NavLink-active" : "")}>RESUME</NavLink></li>
           <li><NavLink to="/projects"  className={({ isActive }) => (isActive ? "NavLink-active" : "")}>PROJECTS</NavLink></li>
